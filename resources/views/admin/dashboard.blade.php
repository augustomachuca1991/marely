<x-admin-layout>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <section class="mb-6 rounded-lg bg-gray-800 p-4 text-gray-100 md:p-8">
                <div class="container m-4 mx-auto grid grid-cols-1 gap-6 md:m-0 md:grid-cols-2 xl:grid-cols-3">
                    <div class="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                        ...
                        <div class="flex flex-1 items-center justify-between p-3">
                            <p class="text-2xl font-semibold">{{ App\Models\Product::all()->count() }}</p>
                            <p>{{ __('Articles') }}</p>
                        </div>
                    </div>
                    <div class="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                        ...
                        <div class="flex flex-1 items-center justify-between p-3">
                            <p class="text-2xl font-semibold">{{ App\Models\User::all()->count() }}</p>
                            <p>{{ __('Users') }}</p>
                        </div>
                    </div>
                    <div class="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                        ...
                        <div class="flex flex-1 items-center justify-between p-3">
                            <p class="text-2xl font-semibold">{{ App\Models\Sale::all()->count() }}</p>
                            <p>{{__('Sales')}}</p>
                        </div>
                    </div>
                    <div class="flex overflow-hidden rounded-lg bg-gray-900 text-gray-100">
                        ...
                        <div class="flex flex-1 items-center justify-between p-3">
                            <p class="text-2xl font-semibold">{{ App\Models\Referral::all()->count() }}</p>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div class="md:col-span-2 lg:col-span-1">
                    <div class="h-full space-y-6 rounded-xl border border-gray-200 bg-white py-8 px-6">
                        <svg class="z-0 m-auto w-40 opacity-75" viewBox="0 0 146 146" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <div>
                            <h5 class="text-center text-xl text-gray-600">Global Activities</h5>
                ...
                <div>
                    <div class="h-full rounded-xl border border-gray-200 bg-white py-6 px-6">
                ...
                <div>
                    <div class="rounded-xl border border-gray-200 bg-white py-8 px-6 text-gray-600 lg:h-full">
                        ...
                        <div class="mt-6">
                            <h5 class="text-center text-xl text-gray-700">Ask to customize</h5>
                            <div class="mt-2 flex justify-center gap-4">
