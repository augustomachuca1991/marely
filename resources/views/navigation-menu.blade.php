        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('suppliers.index') }}" :active="request()->routeIs('suppliers.index')">
                        {{ __('Suppliers') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('audits.index') }}" :active="request()->routeIs('audits.index')">
                        {{ __('Audits') }}
                    </x-jet-nav-link>
                </div>
            </div>
            ...
            <div class="mt-3 space-y-1">
                ...
                @if (\Cart::session(auth()->id())->getTotalQuantity())
                    ...
                    <x-jet-responsive-nav-link href="#">
                        ...
                        <span
                            class="text-xs inline-block py-1 px-1.5 leading-none text-center whitespace-nowrap align-baseline font-bold bg-red-600 text-white rounded-full ml-2">{{ \Cart::session(auth()->id())->getTotalQuantity() }}</span>
                    </x-jet-responsive-nav-link>
                @endif
            </div>
        </div>
