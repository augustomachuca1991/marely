                                    ...
                                    <div class="-mx-1 mb-3 flex flex-wrap">
                                        <template x-for="(day, index) in DAYS" :key="index">
                                            <div style="width: 14.26%" class="px-0.5">
                                                <div x-text="day"
                                                    class="text-center text-xs font-medium text-gray-800"></div>
                                            </div>
                                        </template>
                                    </div>
        ...
        function app() {
            return {
                ...
                getDateValue(date) {
                    ...
                    @this.set('to' ,this.datepickerValueFrom )
