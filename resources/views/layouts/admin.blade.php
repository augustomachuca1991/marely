...
<body>
    ...
    <aside
        ...
        <div>
            <div class="-mx-6 px-6 py-4">
                <a href="{{route('dashboard')}}" title="home">
                    <img src="{{asset('image/logoMarely4.svg')}}" class="w-48" alt="marely logo">
                </a>
            </div>
            ...
            <ul class="mt-8 space-y-2 tracking-wide">
                <li>
                    <a href="{{route('dashboard')}}" aria-label="dashboard"
                        class="relative flex items-center space-x-4 px-4 py-3  {{request()->routeIs('dashboard')? 'rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400  text-white' : 'rounded-md text-gray-600'}}" >
                ...
                <li>
                    <a href="{{route('categories.index')}}" class="group flex items-center space-x-4 px-4 py-3 {{request()->routeIs('categories.index')? 'rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400  text-white' : 'rounded-md text-gray-600'}}">
                ...
                <li>
                    <a href="{{route('reports.index')}}" class="group flex items-center space-x-4 px-4 py-3 {{request()->routeIs('reports.index')? 'rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400  text-white' : 'rounded-md text-gray-600'}}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="-mx-6 flex items-center justify-between border-t px-6 pt-4">
            <button class="group flex items-center space-x-4 px-4 py-3">
